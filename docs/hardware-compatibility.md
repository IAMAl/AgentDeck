...
|---|---|---|---|---|---|---|---|---|---:|---|
| JC8012P4A1C | `ips_10` · `ips10` | ESP32-P4NRW32 + C6 | 16 MB · 32 MB | 10.1″ IPS LCD · 800×1280 | JD9365 MIPI-DSI | GSL3680 touch | Front MIPI-CSI 1080p camera (sensor unconfirmed) · ESP32-C6 Wi-Fi coprocessor · 2× mic + speaker (vendor spec) | CH340 USB serial | 6 MB | Shipping |
